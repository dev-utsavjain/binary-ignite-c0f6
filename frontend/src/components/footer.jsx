...
const Footer = ({ completedCount, onClearCompleted }) => {
  return (
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          {completedCount > 0 && (
            <button
              ...
              className="px-6 py-3 bg-white border-2 border-black text-black font-medium text-sm uppercase tracking-widest hover:bg-black hover:text-white transition-all duration-300"
            >
